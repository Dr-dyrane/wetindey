...
| **H6 ADR-020 nonce-CSP governance** | 🟢 active docs-only lane; four paths exclusively claimed | Product & Data Governance Architect `019f7599-0eaa-7423-9ebf-a1bfea8efe37`; independent refuter Security & Privacy Engineering Lead `019f75e5-8c04-74c0-9392-d9f741a7a131` | `docs/adr/020-per-request-nonce-content-security-policy.md`; `DECISIONS.md`; `WETINDEY_BIBLE.md`; `docs/architecture/SERVICE-ARCHITECTURE.md` | Accept only if the documents specify one enforcing nonce policy, removal of the static Vercel CSP in the later implementation, nonce coverage for all three raw layout scripts and parser-inserted Mapbox script, identical Next 15.5.20 policy on cloned request headers and response, dynamic/no-store and environment-specific consequences, Blob gap, report-only rollout, and exact later code handoff boundaries. One docs-only commit; independent source refutation with no P1/P2. No code/test/build/browser/DB/push/deploy |
...
| `docs/adr/020-per-request-nonce-content-security-policy.md`, `DECISIONS.md`, `WETINDEY_BIBLE.md`, `docs/architecture/SERVICE-ARCHITECTURE.md` | — | **H6 ADR-020 nonce-CSP governance** — Product & Data Governance Architect `019f7599-0eaa-7423-9ebf-a1bfea8efe37`; exact docs-only claim pending independent Security & Privacy refutation |
...
| **H6 ADR-020 nonce-CSP governance** | Product & Data Governance Architect `019f7599-0eaa-7423-9ebf-a1bfea8efe37`; independent Security & Privacy refuter `019f75e5-8c04-74c0-9392-d9f741a7a131` | 🟢 active exact four-path docs claim | `docs/adr/020-per-request-nonce-content-security-policy.md`; `DECISIONS.md`; `WETINDEY_BIBLE.md`; `docs/architecture/SERVICE-ARCHITECTURE.md` | Security/privacy architecture | 2026-07-18 | No current ownership conflict. Acceptance requires one enforcing nonce policy; later same-change removal of static Vercel CSP; nonce coverage of all three raw layout scripts and parser-inserted Mapbox script; identical Next 15.5.20 request/response policy; documented dynamic/no-store, environment, Blob, and report-only implications; and bounded later implementation paths. One docs-only commit plus independent source refutation with no P1/P2. No code/test/build/browser/DB/push/deploy. |
