...
| **Semantic iconography sheet adoption** | 🟢 exact bounded claim recorded; begins after foundation commit | same implementation owner; same independent visual/accessibility refuter | `src/design-system/components/ListRow.tsx`; `src/design-system/components/SheetPicker.tsx`; `src/design-system/components/MapLoader.tsx`; `src/app/_components/SettingsSheet.tsx`; `src/app/_components/ItemDetailSheet.tsx`; `src/app/_components/GetItSheet.tsx`; `src/app/_components/CurrencyPickerSheet.tsx`; `src/app/_components/ExchangePanel.tsx` | Light/dark reused-state, accessible text/name/target, reduced-motion, and semantic-tone refutation required. Excludes currency actions/data, `CurrencyFlag`, flag sprite/licence, `page.tsx`, `actions.ts`, and Contribution paths |
...
| `src/design-system/components/ListRow.tsx`, `src/design-system/components/SheetPicker.tsx`, `src/design-system/components/MapLoader.tsx`, `src/app/_components/SettingsSheet.tsx`, `src/app/_components/ItemDetailSheet.tsx`, `src/app/_components/GetItSheet.tsx`, `src/app/_components/CurrencyPickerSheet.tsx`, `src/app/_components/ExchangePanel.tsx` | Iconography & Visual Systems Lead `019f75cf-4d8f-7263-822b-06e846fce7ac` | **Semantic iconography sheet adoption** — active exact claim, sequenced after foundation |
