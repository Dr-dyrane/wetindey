...
#### Dead profile-sheet copy module removal - RELEASED / PATHLESS

Complete at the removal commit, pushed under the `0bbdb11` class. profile-sheet/copy/copy.ts had zero importers and strings already drifted from the live i18n copy; deleted with profile-sheet added to CENTRALIZED_COPY, static stage green, and the exemption proven load-bearing (un-exempting it while copy/ is gone fails the modularization contract). No runtime change. Paths released.
