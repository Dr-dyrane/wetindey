    ...
    extend: {
      colors: {
        ...
        iconOrb: {
          ...
          "neutral-deep": "var(--color-icon-orb-neutral-deep)",
          "neutral-ink": "var(--color-icon-orb-neutral-ink)",
          "location-top": "var(--color-context-location-orb-top)",
          "location-base": "var(--color-context-location-orb-base)",
          "location-deep": "var(--color-context-location-orb-deep)",
          "location-ink": "var(--color-context-location-orb-ink)",
          "navigation-top": "var(--color-context-navigation-orb-top)",
          "navigation-base": "var(--color-context-navigation-orb-base)",
          "navigation-deep": "var(--color-context-navigation-orb-deep)",
          "navigation-ink": "var(--color-context-navigation-orb-ink)",
          "contact-top": "var(--color-context-contact-orb-top)",
          "contact-base": "var(--color-context-contact-orb-base)",
          "contact-deep": "var(--color-context-contact-orb-deep)",
          "contact-ink": "var(--color-context-contact-orb-ink)",
        },
        domain: {
          food: "var(--color-domain-food)",
          "food-bg": "var(--color-domain-food-bg)",
          "food-orb-top": "var(--color-domain-food-orb-top)",
          "food-orb-base": "var(--color-domain-food-orb-base)",
          "food-orb-deep": "var(--color-domain-food-orb-deep)",
          "food-orb-ink": "var(--color-domain-food-orb-ink)",
          money: "var(--color-domain-money)",
          "money-bg": "var(--color-domain-money-bg)",
          "money-orb-top": "var(--color-domain-money-orb-top)",
          "money-orb-base": "var(--color-domain-money-orb-base)",
          "money-orb-deep": "var(--color-domain-money-orb-deep)",
        ...
        rating: {
          ...
          "orb-top": "var(--color-rating-orb-top)",
          "orb-base": "var(--color-rating-orb-base)",
          "orb-deep": "var(--color-rating-orb-deep)",
        ...
        status: {
          ...
          "confirmed-orb-top": "var(--color-status-confirmed-orb-top)",
          "confirmed-orb-base": "var(--color-status-confirmed-orb-base)",
          "confirmed-orb-deep": "var(--color-status-confirmed-orb-deep)",
          ...
          "caution-orb-top": "var(--color-status-caution-orb-top)",
          "caution-orb-base": "var(--color-status-caution-orb-base)",
          "caution-orb-deep": "var(--color-status-caution-orb-deep)",
          ...
          "unavailable-orb-top": "var(--color-status-unavailable-orb-top)",
          "unavailable-orb-base": "var(--color-status-unavailable-orb-base)",
          "unavailable-orb-deep": "var(--color-status-unavailable-orb-deep)",
