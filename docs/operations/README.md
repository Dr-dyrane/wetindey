...
* **[DEPARTMENT-WORKLOG-PROTOCOL.md](DEPARTMENT-WORKLOG-PROTOCOL.md)**: **Protocol for Department Worklogs** — Rules governing append-only durable memory logs for parallel agents and developers.
