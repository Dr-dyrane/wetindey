...
| [025](docs/adr/025-trusted-people-remote-presence.md) | Trusted People and relationship-scoped remote presence | Proposed | Would permit only a separately consented relationship after opaque invite/QR/handle resolution plus mutual invite/accept; the subject's directional remote-view grant, relationship-scoped profile-display consent, and active ADR-016 foreground lease remain required. ADR-016's reciprocal profile consent remains independent. No public directory, contact sync, follower/popularity effect, exact location, background tracking, or messaging. This proposal authorizes no schema, migration, server, UI, provider, pilot, or rollout. |
