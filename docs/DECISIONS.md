...
| [027](adr/027-ai-routed-general-search.md) | AI-routed General Search over typed truth capabilities | Proposed | Would let AI classify natural-language intent, extract typed constraints, and select one allowlisted live capability. AI never supplies local facts: every answer remains traceable to admitted WetinDey evidence. ADR-010's two-complete-vertical abstraction gate, explicit category fallback, privacy minimization, schema validation, abstention, and deterministic failure remain required. |
