...
export const en = {
  ...
  "report.options_loading": "Loading options…",
  "report.options_failed": "Options did not load.",

  /* Copy riders: home surfaces, recenter control, and the location sheet's
     former local copy module (deleted; these are its bytes verbatim). */
  "home.visit_shop": "Visit shop",
  "home.visit_market": "Visit market",
  "home.prices_count": "{n} prices",
  "map.recenter_a11y": "Recenter on my location",
  "location.sheet_title": "Where are you?",
  "location.load_error": "We no fit load the areas right now.",
  "location.locating": "Finding you…",
  "location.use_my_location": "Use my location",
  "location.try_again": "Try again",
  "location.outside_title": "We found you, but you’re outside our areas",
  "location.back": "Back",
...
const pidgin: LocaleTable = {
  ...
  "report.options_loading": UNTRANSLATED,
  "report.options_failed": UNTRANSLATED,
  "home.visit_shop": UNTRANSLATED,
  "home.visit_market": UNTRANSLATED,
  "home.prices_count": UNTRANSLATED,
  "map.recenter_a11y": UNTRANSLATED,
  "location.sheet_title": UNTRANSLATED,
  "location.load_error": UNTRANSLATED,
  "location.locating": UNTRANSLATED,
  "location.use_my_location": UNTRANSLATED,
  "location.try_again": UNTRANSLATED,
  "location.outside_title": UNTRANSLATED,
  "location.back": UNTRANSLATED,
